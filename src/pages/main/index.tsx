  ...
  return (
    <MainLayout>
      <Switch>
        ...
        <Route exact path="/login" render={_ => <Redirect to="/home" />} />
        <Route exact path="/register" render={_ => <Redirect to="/home" /> } />
        ...
        <Route exact path="/videos" render={_ => <Redirect to='/videos/articles' /> } />
        
        <Route path="/musics/articles/add" component={MusicArticleAdd} />
        <Route path="/musics/articles" component={MusicArticleList} />
        <Route exact path="/musics" render={_ => <Redirect to='/musics/articles' /> } />
